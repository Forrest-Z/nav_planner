...
class TrajectoryProcessor
{
 public:
  ...
  virtual mpac_generic::Trajectory getTrajectory() = 0;
  virtual void addPathInterface(const mpac_generic::PathInterface &path) = 0;
  virtual void addCoordinatedTimes(const mpac_generic::CoordinatedTimes &times) = 0;

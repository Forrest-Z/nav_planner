...
constraint_extract::PolygonConstraint createPolygonConstraintFromPolygonConstraintMsg(const mpac_msgs::PolygonConstraint &msg) {
...
constraint_extract::PolygonConstraintsVec createPolygonConstraintsVecFromRobotConstraintsMsg(const mpac_msgs::RobotConstraints &msg) {
...
mpac_msgs::RobotConstraints createRobotConstraintsFromPolygonConstraintsVec(const constraint_extract::PolygonConstraintsVec &pcv) {
  mpac_msgs::RobotConstraints msg;
  for (size_t i = 0; i <  pcv.size(); i++) {
    mpac_msgs::PolygonConstraint poly = createPolygonConstraintMsgFromConvexPolygon(pcv[i].getInnerConstraint());
    ...
    mpac_msgs::PolygonConstraint poly_outer = createPolygonConstraintMsgFromConvexPolygon(pcv[i].getOuterConstraint());

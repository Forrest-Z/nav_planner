...
public:
  ...
  mpac_generic::Pose2dCov getPose2dCov(const mpac_generic::Pose2d &rel) const
  {
    Pose2dCov ret;
    ret.mean = rel;
  ...
  Eigen::MatrixXd getCovMatrix6(const mpac_generic::Pose2d &rel) const
  {
...
namespace boost {
  namespace serialization {
    ...
    void serialize(Archive& ar, mpac_generic::MotionModel2d::Params& o, const unsigned int version) {
      ar & o.Cd
        & o.Ct
        & o.Dd
        & o.Dt

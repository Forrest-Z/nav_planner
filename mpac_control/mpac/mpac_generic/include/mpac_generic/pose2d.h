...
public:
  ...
  Pose2d mean;
  Eigen::Matrix3d cov;
  friend std::ostream &operator<<(std::ostream &os, const mpac_generic::Pose2dCov &obj)
  {
    os << "\n[mean] : \n"
       << obj.mean;
    os << "\n[cov ] : \n"
...
inline bool addStepPose2d(const mpac_generic::Pose2d &p1, const mpac_generic::Pose2d &p2, double maxDist, double maxRotation)
{
...
inline mpac_generic::Pose2d pose2dFromAffine3d(const Eigen::Transform<double, 3, Eigen::Affine, Eigen::ColMajor> &T)
{
  Pose2d ret;
...
inline void pose2dClearDependence(mpac_generic::Pose2dCov &posecov)
{
  posecov.cov(0, 1) = 0.;
  posecov.cov(1, 0) = 0.;
  posecov.cov(0, 2) = 0.;

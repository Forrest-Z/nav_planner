...
#include <mpac_global_planner/ModelUtilities.h>
...
int main(int argc, char** argv) {
  ...
  desc.add_options()
    ...
    ("prim_dir", po::value<std::string>(&prim_dir)->default_value(std::string("/home/han/catkin_ws/src/mpac/mpac_motion_planner/Primitives/")), "primitives directory (.mprim file)")
    ("tab_dir", po::value<std::string>(&tab_dir)->default_value(std::string("/home/han/catkin_ws/src/mpac/mpac_motion_planner/LookupTabeles/")), "lookup tables directory (.hst file)")

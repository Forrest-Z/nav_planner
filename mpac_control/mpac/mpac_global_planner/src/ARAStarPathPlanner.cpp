...
#include "mpac_global_planner/ARAStarPathPlanner.h"
#include <iostream>

ARAStarPathPlanner::ARAStarPathPlanner(PathNode *startNode, World *world, boost::posix_time::ptime startTime, int timeAllowed) : AStar(startNode)
{
	w_ = world;

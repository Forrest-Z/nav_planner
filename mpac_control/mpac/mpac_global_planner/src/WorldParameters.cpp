...
unsigned long int WP::EXPANSION_QUEUE_MAX = 1000000000;
...
bool WP::PASSABLE_UNKNOWN_SPACE = false;
bool WP::USE_FAST_PLAN_MODE = true;

int WP::DECIMAL_APPROXIMATION = 4;
WP::NodeExpansionMethod WP::NODE_EXPANSION_METHOD = WP::NodeExpansionMethod::EPFSG;

	
float WP::RADIUS_CAR_INSCRIBED = 0.3;
	/** 机器人外切半径 */
float WP::RADIUS_CAR_EXTERNAL =  0.5;


bool WP::USE_GRID_DISTANCE = true;

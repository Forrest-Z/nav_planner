...
int main(int argc, char** argv) {
  ...
  desc.add_options()
    ...
    ("tab_dir", po::value<std::string>(&tab_dir)->default_value(std::string("/home/han/catkin_ws/src/mpac/mpac_motion_planner/LookupTables/")), "lookup tables directory (.hst file)")

...
public:
	 ...
	 */
	PathFinder(WorldOccupancyMap* map);
	...
	std::vector<mpac_generic::Pose2d> solve();
	...
	bool targetPointIsOccupied(mpac_generic::Pose2d pose, double left_width, double right_width, double front_length, double back_length);

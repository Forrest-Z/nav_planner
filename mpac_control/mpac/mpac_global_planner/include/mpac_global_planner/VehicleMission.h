...
public:
	 ...
	 */
	void updateMission(double start_x, double start_y, double start_o, double start_steering,double goal_x, double goal_y, double goal_o, double goal_steering, std::string name = "");
	
	bool isNeedUpdateGridDistanceFromGoal;

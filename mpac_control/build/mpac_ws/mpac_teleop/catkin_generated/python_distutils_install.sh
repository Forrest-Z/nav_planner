...
echo_and_run cd "/home/lxf/lxf_work/learning_mpac/mpac_control/src/mpac_ws/mpac_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/home/lxf/lxf_work/learning_mpac/mpac_control/src/mpac_ws/mpac_teleop/setup.py" \
     \
    build --build-base "/home/lxf/lxf_work/learning_mpac/mpac_control/build/mpac_ws/mpac_teleop" \
    install \
    --root="${DESTDIR-/}" \
